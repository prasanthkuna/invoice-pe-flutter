  ...
  group('🔥 PhonePe Sandbox Complete Validation', () {
    ...
    patrolTest(
      ...
      ($) async {
        ...
        print('📋 Transaction Data: $transactionResponse');
        ...
        expect(
          transactionResponse['rewards_earned'],
          equals(testAmount * 0.015),
        );
        ...
        if (authTokenResponse.isNotEmpty) {
          ...
          print('🔑 Auth Token Data: $tokenData');
        ...
        if (vendorId != null) {
          ...
          print('🏢 Vendor Data: $vendorResponse');
        ...
        if (invoiceId != null) {
          ...
          print('📋 Invoice Data: $invoiceResponse');
        ...
        try {
          ...
          print('⚠️ phonepe-auth function: $e');
        }
        ...
        try {
          ...
          print('⚠️ create-phonepe-order function: $e');
        }
        ...
        if (phonepeOrderId != null) {
          try {
            ...
            print('⚠️ verify-phonepe-payment function: $e');
          }
        }
