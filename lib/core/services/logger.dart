...
class ComponentLogger {
  ...
  void warn(String operation, Map<String, dynamic> data, {
    String? suggestion,
  ...
  void _outputConsole(LogEntry entry) {
    final message = '[${entry.level.name.toUpperCase()}] '
  ...
  void _outputPretty(LogEntry entry) {
    ...
    buffer.writeln('$color━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1B[0m');
    buffer.writeln('$color${entry.level.name.toUpperCase()}\x1B[0m ${entry.component}.${entry.operation}');
    ...
    if (entry.context['file'] != null) {
      buffer.writeln('Location: ${entry.context['file']}:${entry.context['line']} in ${entry.context['function']}()');
    }
  ...
  void _prettyPrintMap(Map<String, dynamic> map, StringBuffer buffer, String indent) {
