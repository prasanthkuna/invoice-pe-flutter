...
final class PaymentSuccess extends PaymentResult {
  ...
  @override
  String toString() =>
      'PaymentSuccess(txnId: $transactionId, amount: $amount, rewards: $rewards)';
}
...
final class PaymentCancelled extends PaymentResult {
  ...
  @override
  String toString() =>
      'PaymentCancelled(reason: $reason, txnId: $transactionId)';
}
...
final class PaymentProcessing extends PaymentResult {
  ...
  @override
  String toString() =>
      'PaymentProcessing(txnId: $transactionId, message: $message)';
}
...
class PaymentInitData {
  ...
  @override
  String toString() =>
      'PaymentInitData(txnId: $merchantTransactionId, amount: $amount)';
}
...
class PhonePeResponse {
  ...
  @override
  String toString() =>
      'PhonePeResponse(status: $status, code: $code, message: $message)';
}
