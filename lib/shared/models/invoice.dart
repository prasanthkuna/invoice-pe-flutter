...
class Invoice with InvoiceMappable {
  ...
  final DateTime? updatedAt;      // Optional - set on updates
  ...
  factory Invoice.forPayment({
    ...
    final generatedInvoiceNumber = invoiceNumber ?? 'INV-${now.millisecondsSinceEpoch}';
  ...
  static Invoice fromMap(Map<String, dynamic> map) => InvoiceMapper.fromMap(map);
